CREATE TABLE CONTATO (ID  SERIAL NOT NULL, NASCIMENTO DATE, NOME VARCHAR(255), VERSAO BIGINT, idcontato INTEGER, PRIMARY KEY (ID))
...
ALTER TABLE CONTATO ADD CONSTRAINT FK_CONTATO_idcontato FOREIGN KEY (idcontato) REFERENCES ENDERECO (ID)
